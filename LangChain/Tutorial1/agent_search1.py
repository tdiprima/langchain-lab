...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You are a helpful AI assistant with access to a search tool. You must ONLY use the information returned by the search tool in your responses - do not add any additional information or ask follow-up questions about location, time, or other specifics. Simply relay what the search tool tells you."),
