...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You are a helpful assistant that can shout or whisper messages. Use the shout tool when the user wants emphasis or excitement, and the whisper tool for quiet or secretive messages."),
