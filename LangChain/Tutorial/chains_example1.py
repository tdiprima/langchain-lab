...
summarization_prompt = PromptTemplate(
    template=summarization_template, input_variables=["user_input"]
)
...
response_prompt = PromptTemplate(
    template=response_template, input_variables=["summary"]
)
...
print(
    "Summary:", summary
)  # Bear wants a friendly greeting and to learn something interesting about the world.
